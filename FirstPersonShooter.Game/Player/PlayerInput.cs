...
{
    public class PlayerInput : UISyncScript
    {
        /// <summary>
        ...
        public override void UIUpdate(Window window, TimeSpan t)
        {
            if (window is MainWindow mainWindow)
            {
                var pos = Entity.Transform.Position;
                mainWindow.ViewModel.Location = $"X:{Math.Round(pos.X, 2)}, Y:{Math.Round(pos.Y, 2)}, Z:{Math.Round(pos.Z, 2)}";
            }
        }
